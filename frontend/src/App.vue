<template>
  <div class="app-container">
    ...
    <main class="app-main">
      ...
      >
        <template #default>
          <el-button size="small" type="danger" plain @click="store.retry()" :loading="store.loading">
            🔄 重新尝试
          </el-button>
        </template>
      </el-alert>
...
.error-bar :deep(.el-alert__content){flex:1}
.error-bar .el-button{margin-top:6px}
</style>